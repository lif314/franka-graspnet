...
from foundation_stereo.Utils import *
from foundation_stereo.core.foundation_stereo import *

if __name__=="__main__":
  parser = argparse.ArgumentParser()
  parser.add_argument('--left_file', default='./foundation_stereo/assets/left.png', type=str)
  parser.add_argument('--right_file', default='./foundation_stereo/assets/right.png', type=str)
  parser.add_argument('--intrinsic_file', default='./foundation_stereo/assets/K.txt', type=str, help='camera intrinsic matrix and baseline file')
  parser.add_argument('--ckpt_dir', default='./checkpoints/foundation_stereo/11-33-40/model_best_bp2.pth', type=str, help='pretrained model path')
  parser.add_argument('--out_dir', default='log/fs_pc', type=str, help='the directory to save results')
